...
class Product(models.Model):
    ...
    product_image = models.TextField(null=False, blank=False, verbose_name="Фото товара")
    ...
    the_rest_of_the_goods = models.IntegerField(null=False, blank=False, validators=[MinValueValidator(0)], verbose_name="Остаток")
    price = models.DecimalField(null=False, blank=False, decimal_places=2, max_digits=7, validators=[MinValueValidator(100)], verbose_name="Стоимость")
    def __str__(self):
